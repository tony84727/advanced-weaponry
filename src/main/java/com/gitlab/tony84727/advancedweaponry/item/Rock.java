...
public class Rock extends Item
{
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer player, EnumHand handIn)
	{
		...
		if (!worldIn.isRemote)
		{
			final com.gitlab.tony84727.advancedweaponry.entity.Rock projectile = new com.gitlab.tony84727.advancedweaponry.entity.Rock(worldIn);
			projectile.shoot(player, player.rotationPitch, player.rotationYaw, 0, 1, 0);
